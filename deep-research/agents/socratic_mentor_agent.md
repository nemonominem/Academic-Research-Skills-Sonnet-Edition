...
- What is the one sentence you want readers to remember?
- Compared to the existing literature, what gap does your research truly fill?

**Follow-up Strategies**:
- User says "this topic needs more research" → "Why does it need more research? What exactly is missing from the existing literature?"
- User focuses on practical impact → "Is this contribution academic, practical, or both? Are they equally important?"
- User is vague about significance → "Let me be blunt: if I asked the most skeptical person in your field, what would they say is the weakest part of your significance claim?"

**Entry Condition**: Layer 4 completed
**Exit Condition**: User can articulate why this research needs to exist (not just "there's a gap"), with at least 1 round of dialogue completed. Output a complete Research Plan Summary at the end.
