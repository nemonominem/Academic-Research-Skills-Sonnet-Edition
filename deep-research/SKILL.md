---
name: deep-research
description: "Universal deep research agent team. 13-agent pipeline for rigorous academic research on any topic. 7 modes: full research, quick brief, paper review, lit-review, fact-check, Socratic guided research dialogue, and systematic review with optional meta-analysis. Triggers on: research, deep research, literature review, systematic review, meta-analysis, PRISMA, evidence synthesis, fact-check, guide my research, help me think through, 研究, 深度研究, 文獻回顧, 文獻探討, 系統性回顧, 後設分析, 事實查核, 引導我的研究."
model: sonnet
metadata:
  version: "2.9.4-sonnet"
...
**v2.4** adds writing quality improvements:
- **Style Profile consumption** (optional) — If a Style Profile is available from academic-paper intake, the report compiler applies it as a soft guide.
...
**Default rule**: When intent is ambiguous between `socratic` and `full`, **prefer `socratic`** — it is safer to guide first than to produce an unwanted report.
...
| 4 | `source_verification_agent` | Fact-checking, source grading (evidence hierarchy), predatory journal detection | Phase 2 |
...
| 7 | `editor_in_chief_agent` | Editorial review: originality, rigor, evidence sufficiency, verdict (Accept/Revise/Reject) | Phase 5 |
...
| 10 | `socratic_mentor_agent` | Guides research thinking through Socratic questioning across 5 layers | Socratic Mode (Layer 1-5) |
| 11 | `risk_of_bias_agent` | Assesses risk of bias using RoB 2 (RCTs) and ROBINS-I (non-randomized) | Systematic Review (Phase 2) |
...
| 13 | `monitoring_agent` | Post-research literature monitoring: digests, retraction alerts, contradictory findings detection | Optional |
...
User Input
    ...
    |   +-- Yes --> Need PRISMA-compliant systematic review?
...
=== Phase 5: REVIEW (Parallel) ===
     ...
     |   - AI disclosure compliance, attribution integrity
     |   - Dual-use screening, fair representation
...
3. ⚠️ **IRON RULE**: **Ethics Review** confirms integrity concerns (fabrication / plagiarism / missing AI disclosure). Overridable with recorded reasoning.
...
|---------|---------|---------|
| RQ cannot converge | Phase 1 exceeds multiple rounds while still vague | Provide 3 candidate RQs or suggest lit-review |
| Insufficient literature | bibliography finds < 5 sources | Expand search strategy, alternative keywords |
...
| Ethics BLOCKED | Critical integrity issue | Stop the user once to confirm; overridable with recorded reasoning |
...
| `references/literature_monitoring_strategies.md` | Google Scholar alerts, PubMed alerts, RSS feeds, Retraction Watch | monitoring_agent |
| `references/argumentation_reasoning_framework.md` | Cognitive framework: Toulmin model, causal reasoning, epistemic status | synthesis, devils_advocate, socratic_mentor |
| `references/socratic_mode_protocol.md` | Full 5-layer Socratic dialogue flow, management rules | socratic_mentor, research_question |
...
| 3 | **Vibe citing** | Mixing elements from 2-3 real papers into a fabricated reference | Every reference must be verified independently |
...
| 5 | **Skipping phases** | Jumping to synthesis before completing source verification | Complete each phase fully |
| 6 | **Shallow Socratic mode** | Giving answers disguised as questions ("Wouldn't you say X is true?") | Ask genuine questions that expose assumptions |
| 7 | **Source tier inflation** | Treating a blog post as equivalent to a peer-reviewed journal | Apply evidence hierarchy strictly |
...
| Item | Content |
|------|---------|
| Skill Version | 2.9.4-sonnet |
| Last Updated | 2026-06-06 |
| Maintainer | Cheng-I Wu (Sonnet Edition) |
